(function(jQuery){
	...
	$.fn.BreakingNews = function(settings){
		...
		window.setInterval(() => {
			time++;
			if(time%9 == 0) {
				$('.highlightCurrency').addClass('animate__flipOutX')
			} else if (time%9 == 1) {
				$('.highlightCurrency').removeClass('animate__flipOutX')
				$('.highlightCurrency').addClass('animate__flipInX')
			} else if (time%9 == 2) {
				$('.highlightCurrency').removeClass('animate__flipInX')
			}
